...
class Execute_Order:
    ...
    def Execute_InGameCommands(self):
        ...
        while Bridge.WinnerFound == False:
            cmdSCObj.InBetweenRounds()
            between_rounds = ocrObj.BetweenRounds_Check()
            cmdSCObj.Delete_InBetweenRounds()
...
class CMDscreenShots:
    ...
    def InBetweenRounds(self):
        image = pyautogui.screenshot('IntermissionCheck.png', region=(901, 201, 763, 129))

    def Delete_InBetweenRounds(self):
        os.remove('IntermissionCheck.png')

    def ChatBoxScreenShot(self):
        #time.sleep(0.5)
        image = pyautogui.screenshot('BlinkCommandSC.png', region=(53, 804, 531, 150)) # region changes depending on whether it is in lobby: (0, 1000, 640, 380)    160 WAS 120!!
        #time.sleep(0.5)
...
class OCR:
    ...
    def BetweenRounds_Check(self):
        image = Image.open('IntermissionCheck.png')
...
class ResultProcessing: # fix this
    def __init__(self):
        ...
        self.image = pyautogui.screenshot('WinnerCheck.png', region=(224, 558, 2107, 314))
    ...
    def ImageSkew(self):
        self.image.save('BlackOutTest.png')
        self.image2 = Image.open('BlackOutTest.png')
        ...
        self.image3 = Image.open('WinnerPreOCR.png')

    def WinnerOCR(self):
        text = pytesseract.image_to_string(self.image3, lang='eng')
